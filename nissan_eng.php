<html>
	...
	<div>
		...
		<center>
		<img src= "image/nissan1.jpg" width="1780" height="300"  / ></center>
		...
		<div style="color: white; font-size:40px; text-align:center;"> Nissan Engine Parts</div><br><br>
	 	...
	 	<?php
			...
			$sql = "select parts.*,images.image_name from parts inner join categories on categories.id = parts.categories_id inner join cars on cars.id = parts.cars_id inner join images on parts.id = images.parts_id where parts.cars_id =10 and parts.categories_id=1";
