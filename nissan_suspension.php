<html>
	...
	<fieldset>
	<div>
		<h1 style="color: white;text-align: center;"> nissan Gtr </h1>
		...
		<div style="color: white; font-size:40px; text-align:center;"> nissan Suspension Parts</div><br><br>
	 	...
	 	<?php
			...
			$sql = "select parts.*,images.image_name from parts inner join categories on categories.id = parts.categories_id inner join cars on cars.id = parts.cars_id inner join images on parts.id = images.parts_id where parts.cars_id =10 and parts.categories_id=4";
