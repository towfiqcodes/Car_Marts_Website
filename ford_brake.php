<html>
	...
	<div>
		...
		<center>
		<img src= "image/ford4.jpg" width="1320" height="300"  / ></center>
		...
		<div style="color: white; font-size:40px; text-align:center;"> Ford RS Brake Parts</div><br><br>
	 	...
	 	<?php
			...
			$sql = "select parts.*,images.image_name from parts inner join categories on categories.id = parts.categories_id inner join cars on cars.id = parts.cars_id inner join images on parts.id = images.parts_id where parts.cars_id =13 and parts.categories_id=2";
			...
			if (!empty($result)) {
			    ...
			    while($row = $result->fetch_assoc()) {
		    		...
		    		echo '<input type="image" src="image/brake/'.$row["image_name"].'" width="300" height="200" alt="Submit">';
