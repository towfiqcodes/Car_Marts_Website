<html>
	...
	<div>
		...
		<div style="color: white; font-size:40px; text-align:center;"> Ford RS Suspension Parts</div><br><br>
	 	...
	 	<?php
			...
			$sql = "select parts.*,images.image_name from parts inner join categories on categories.id = parts.categories_id inner join cars on cars.id = parts.cars_id inner join images on parts.id = images.parts_id where parts.cars_id =13 and parts.categories_id=4";
